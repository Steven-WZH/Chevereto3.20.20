                ...
                <div class ="text-content">
                    ...
                    <?php
                        $code = getenv('CHEVERETO_SERVICING') == 'docker'
                            ? 'docker exec -it --user www-data -e THREAD_ID=1 chv-container /usr/local/bin/php /var/www/html/cli.php -C importing'
                            : 'sudo -u www-data php '.G_ROOT_PATH.'cli.php -C importing'
                            
                    ?>
                    <div class="margin-bottom-10">
                        <code class="code display-block"><?php echo $code; ?></code>
                    </div>
                    ...
                    if (get_dashboard() == 'settings') {
						...
						<?php if (get_settings()['key'] == 'image-upload') { ?>
                            ...
                            <div class="input-label">
								...
								<div class="c5 phablet-c1"><select type="text" name="enable_uploads_url" id="enable_uploads_url" class="text-input">
										<?php
                                        echo CHV\Render\get_select_options_html([1 => _s('Enabled'), 0 => _s('Disabled')], CHV\Settings::get('enable_uploads_url')); ?>
									</select></div>
								<div class="input-below"><?php _se("Enable this if you want to allow image upload from URLs."); ?> <?php _se("Note that enabling this will expose your server IP."); ?></div>
							</div>
                            <div class="input-label">
